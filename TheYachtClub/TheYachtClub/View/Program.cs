...
namespace TheYachtClub
{
    class Program
    {
        ...
        */
         ...
         */
        private static void member_edit(){
         ...
         */
        private static void delete_User(string personal_id){
        ...
        */
        private static void edit_boat_Info(string personal_id){
        ...
        * Submenu that gives the user the option of editing the boat
        */
        private static void delete_Boat(string personal_id){
        ...
        */
        private static void add_Boat(string personalID){
            //show list of boats
        ...
        */
        private static void edit_Last_name(string personal_id){
        ...
        */
        private static void edit_First_name(string personal_id){
        ...
        */
        private static void verbose_view()
        {
            // i need 
        ...
        */
        private static void compact_view()
        {
        ...
        */
        private static void member_view()
        {
            //List of members
